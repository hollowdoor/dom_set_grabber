...
rollup.rollup({
    ...
    b.then(what=>{
        ...
        try{
            var result = UglifyJS.minify('dist/dom-set-grabber.js');
            //console.log('result ',result)
            writeFile('dist/dom-set-grabber.min.js', result.code, onErrorCB('minify'));
        }catch(e){
